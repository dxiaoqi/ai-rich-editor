...
import PromptContainerWithConversation from "./components/prompt-container-with-conversation";
...
export default function Component() {
  ...
  const { selectedModel, setSelectedModel, systemMessage, setSystemMessage } = useContext(ModelContext);
  ...
  const onModelChange = (keys: Selection) => {
    ...
    if (newModel) {
      setSelectedModel?.(newModel as string);
    }
  };
